...
public final class CameraManager {
    ...
    public synchronized Rect getFramingRect() {
        if (framingRect == null) {
            ...
            LogUtil.d(TAG, "x:" + screenResolution.x);
            LogUtil.d(TAG, "y:" + screenResolution.y);
            ...
            LogUtil.d(TAG, "left:" + leftOffset);
            LogUtil.d(TAG, "top:" + topOffset);
            LogUtil.d(TAG, "right:" + (leftOffset + width));
            LogUtil.d(TAG, "bottom:" + (topOffset + height));
    ...
    private static int findDesiredDimensionInRange(int resolution, int hardMin, int hardMax) {
        int dim = (int) (resolution * 0.7f); // Target 5/8 of each dimension
        if (dim < hardMin) {
            return hardMin;
        }
        if (dim > hardMax) {
